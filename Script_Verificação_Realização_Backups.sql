...
SET @DBNAME='CLARO_BA_FINANCEIRO'--NULL  -- Default NULL(All Databses)
select 
	'BackUp Name'=BS.name
	...
	,'Time Taken'=cast(datediff(ss,BS.backup_start_date,BS.backup_finish_date)/3600 as varchar(10))
	+' Hours, '+cast(datediff(ss,BS.backup_start_date,BS.backup_finish_date)/60 as varchar(10))
	+' Minutes, '+cast(datediff(ss,BS.backup_start_date,BS.backup_finish_date)%60 as varchar(10)) 	
	+' Seconds'
